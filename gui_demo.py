...
class MainWindow(QMainWindow):
    ...
    def ncc_operator(self):
        ...
        ncc_output_path = 'images/ncc.png' 
        ...
        self.ncc_time.setText(str(3.942026) + ' sec')
    ...
    def ssd_operator(self):
        ...
        ssd_output_path = 'images/ssd.png' 
        ...
        self.ssd_time.setText(str(14.870997) + ' sec')
    ...
    def sift_operator(self):
        ...
        sift_output_path = 'images/sift_cat.jpeg' 
        ...
        self.sift_time.setText(str(42) + ' sec')
